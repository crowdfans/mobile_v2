...
abstract final class ApiUrls {
  ...
  static const meetEventStartServing =
      '/api/v1/meet-events/:eventId/start-serving';
  static const meetEventCallNext = '/api/v1/meet-events/:eventId/call-next';
  static const meetEventFinish = '/api/v1/meet-events/:eventId/finish';
  ...
  static const meetEventCallEnd = '/api/v1/meet-events/calls/:callId/end';
  static const meetEventCallEarlyEndReport =
